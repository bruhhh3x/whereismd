...
export default function App() {
  ...
  const currentQuestion =
    stage === "questions" && questions.length > 0 ? questions[index] : null;
  ...
  function start() {
    ...
    const selected = shuffled.slice(
      0,
      Math.min(QUESTIONS_PER_RUN, shuffled.length)
    );
    ...
    >
      {stage === "intro" && (
        ...
        >
          ...
          >
            Let’s play a variation of 21 Questions. Answer quickly. Don’t
            overthink.
          </p>
          <p
            style={{
      ...
      {stage === "form" && !submitted && (
        ...
        >
          ...
          <Field
            label="Pronouns"
            value={form.pronouns}
            onChange={(v) => handleFormChange("pronouns", v)}
          />
          <Field
            label="Location"
            value={form.location}
